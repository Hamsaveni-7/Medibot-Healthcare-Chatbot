...
db = SQLAlchemy(app)
app.secret_key = "s3cr3t_k3y_f0r_y0ur_app"
...
def ddg(query, region='wt-wt', safesearch='Off', time='y'):
    # Base URL for DuckDuckGo search
    url = f'https://duckduckgo.com/html/?q={query}&kp=-1&kl={region}&kae={safesearch}&kz={time}&kaq=-1&kak=-1&kax=-1&kap=-1&kam=osm&kac=-1&kad=-1'
...
# Your existing Flask routes and functions go here...
